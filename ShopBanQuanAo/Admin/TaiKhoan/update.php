...
<div class="form-container">
    ...
    <form method="POST" action="index.php?act=sua_action_Tk&maTK=<?=$maTK?>">
        ...
        <div class="form-group">
            ...
            <select id="quyenhan" name="quyenhan" required>
                <option value="0" <?php if($quyen == 0) {echo "selected";}  ?>>Khách hàng</option>
                <option value="1" <?php if($quyen == 1){echo "selected";}  ?>>Nhân viên</option>
            </select>
        </div>
        <div class="form-group">
            <label>Trạng Thái Hoạt Động:</label>
            <label class="labelRadio" for="isActiveYes">Có</label>
            <input type="radio" id="isActiveYes" name="trangThai" value="1" <?=($trangthaiTK == 1) ? 'checked' : ''?>>
            <label class="labelRadio" for="isActiveNo">Không</label>
            <input type="radio" id="isActiveNo" name="trangThai" value="0" <?=($trangthaiTK == 0) ? 'checked' : ''?>>
        </div>
        <div class="form-group">
