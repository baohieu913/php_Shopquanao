...
<div class="form-container">
    ...
    <form method="POST" action="index.php?act=addTk">
        ...
        <div class="form-group">
            ...
            <input type="text" id="matkhau" name="matkhau" placeholder="Nhập mật khẩu" required>
        </div>
        <div class="form-group">
            <label for="tennguoidung">Tên Người Dùng:</label>
            <input type="text" id="tennguoidung" name="tennguoidung" placeholder="Nhập tên người dùng" required>
        </div>
        <div class="form-group">
            <label for="diachi">Địa Chỉ:</label>
            <input type="text" id="diachi" name="diachi" placeholder="Nhập địa chỉ" required></input>
        </div>
        <div class="form-group">
            <label for="sodienthoai">Số Điện Thoại:</label>
            <input type="text" id="sodienthoai" name="sodienthoai" placeholder="Nhập số điện thoại" required></input>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <button type="submit" name="themtaikhoan">Thêm Thông Tin</button>
        </div>
    </form>
    <?php 
