                ...
                <div class="grid__row app__content">
                            ...
                            <ul class="category-list">
                                <?php 
                                    foreach ($danhMuc as $loaiSP) {
                                        ...
                                        if($trangthaiLoai == 1){
                                                    if(isset($_GET['act']) && ($_GET['act']=='SPtheoDM')){
                                                        if($_GET['maLoai'] == $maLoai){
                    ...
                    <div class="grid__column-10">
                        ...
                        <div class="home-product">
                            <div class="grid__row">
                                ...
                                <?php 
                                    ...
                                    foreach ($sanphamtheoloai as $dsSP) {
                                        extract($dsSP);
                        ...
                        <ul class="pagination home-product__pagination">
                            ...
                            <?php
                                for ($i = 1; $i <= $total_page_theoloai; $i++) {
                                    if($i == $pageloai){
                                        echo '  <li class="pagination-item pagination-item--active">
                                                    <a href="index.php?act=SPtheoDM&pageloai='.$i.' &maLoai='.$maLoai.'" class="pagination-item__link">'.$i.'</a>
                                                </li>';
                                    }
                                    else {
